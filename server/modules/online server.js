...
const cH = 735, 
cW = 1540,
VELOCIDADE_INICIAL = cW/154,
ACELERACAO_INICIAL = 1,
PONTOS_VITORIA = 11

let j1 = new Raquete({x: 20, y: 150}, 5, {e: 0, d: cW/2 - cW/16}, "#0000FF", "P1"),
j2 = new Raquete({x: 20, y: 150}, cW - 5, {e: cW/2 + cW/16, d: cW}, "#FF0000", "P2"),
bola = new Bola({x: 30, y: 30}, 120, "#EEEEEE")

if (Math.random() < 0.5)
    bola.posicao.x = cW - bola.posicao.x - bola.largura

j1.posicao.x += j1.largura
j1.posicaoInicial.x += j1.largura
...
function box() {
    ...
    //Overtime
    else if (j1.pontos  === 10 && j2.pontos  === 10 && j1.altura > 111) {
